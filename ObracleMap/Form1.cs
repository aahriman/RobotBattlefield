...
namespace ObracleMap {
    public partial class Form1 : Form {
        ...
        private IDictionary<Point, IObtacle> obtacles = new Dictionary<Point, IObtacle>();
        ...
        private void fillListBox() {
            ...
            IEnumerable<Type> obtacleTypes = Assembly.GetAssembly(typeof(IObtacle)).GetTypes()
                .Where(t =>
                    t.IsClass &&
                    typeof(IObtacle).IsAssignableFrom(t));
        ...
        private void addObtacle(Point p, String obtacleName) {
            ...
            if (!CLEAR_OBTACLE.Equals(listBox1.SelectedItem)) {
                IObtacle obtacle = ObtacleManager.GetObtacle(obtacleName, p.X, p.Y);
