...
namespace CommunicationLibrary.command.v1._0 {
	internal class MerchantCommandV1_0 : MerchantCommand, ACommand.Sendable{
        ...
        private sealed class CommandFactory : ACommandFactory {
            ...
            public override bool IsTransferable(ACommand c) {
                if (c is MerchantCommand) {
                    ...
                    cache.Cached(c, new MerchantCommandV1_0(c2.MOTOR_ID, c2.GUN_ID, c2.ARMOR_ID, c2.REPAIR_HP));
                    return true;
                }
                return false;
            }
        ...
        public string serialize() {
            return String.Format("MERCHANT({0};{1};{2};{3})", MOTOR_ID, GUN_ID, ARMOR_ID, REPAIR_HP);
        }
    }
}
